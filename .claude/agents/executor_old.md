...
### 🛑 レビュー未実施の防止
**以下のチェックリストを完了しないと次に進めません：**
- [ ] 実装が完了した
- [ ] テスト/動作確認が完了した
- [ ] 結果を`docs/results/step_XXX.md`に記録した
- [ ] **@reviewerを呼び出してレビューを依頼した** ← 必須
- [ ] レビュー結果を受け取った

⚠️ **警告**: レビューを受けずに次のステップに進むことは禁止されています。
必ず`@reviewer`を呼び出し、レビュー結果を待ってから`@planner`に引き継いでください。
